...
getMurId = function(callback) {
  new Fingerprint2().get(function(result, components) {
    ...
    $.ajax({
      ...
      dataType: 'json',
      type: 'POST',
      url: 'http://' + server_type + _region + '-member.iscarmg.com/api/account/machineconnect',
      data: JSON.stringify(JSON.stringify(_m)),
      success: function(r) {
