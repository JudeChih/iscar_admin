var shopdata = {
	text: {
		sd_type_text: [
            '全部類型','二手車商','汽車鍍膜', '保養維修', '輪胎避震', '周邊配備','宮廟','未分類'
        ],
        scm_category: [
            ['全部類別','汽車美容','汽車維修','汽車百貨','汽車零件'],
            ['-1','0','1','2','3']
        ]
	},
	sd_type: {
	...
	countries: [
        '全部縣市','臺北市', '基隆市', '新北市', '宜蘭縣', '新竹市', '新竹縣', '桃園市', '苗栗縣', '臺中市',
        '彰化縣', '南投縣', '嘉義市', '嘉義縣', '雲林縣', '臺南市', '高雄市', '澎湖縣',
        '屏東縣', '臺東縣', '花蓮縣', '金門縣', '連江縣'
    ],
    region: {
        全部縣市: [
        ...
        屏東縣: [
            ['屏東市', '三地門', '霧臺鄉', '瑪家鄉', '九如鄉', '里港鄉', '高樹鄉', '鹽埔鄉',
